...
namespace MonoidEngine.DearImGui;
...
public static class DImGui
{
    ...
    private static void SetStyle()
    {
        ...
        colors[(int)ImGuiCol.TextDisabled] = White.ARGBSetAlpha(0.6f);
        colors[(int)ImGuiCol.WindowBg] = Dark2.ARGBSetAlpha(0.9f);
        colors[(int)ImGuiCol.ChildBg] = Dark1.ARGBSetAlpha(0.9f);
        colors[(int)ImGuiCol.PopupBg] = Dark1.ARGBSetAlpha(0.9f);
        colors[(int)ImGuiCol.Border] = Medium0;
        colors[(int)ImGuiCol.BorderShadow] = new(0.00f);
        colors[(int)ImGuiCol.FrameBg] = Dark1.ARGBSetAlpha(0.8f);
        colors[(int)ImGuiCol.FrameBgHovered] = Dark2.ARGBSetAlpha(0.8f);
        colors[(int)ImGuiCol.FrameBgActive] = Medium0.ARGBSetAlpha(0.8f);
        colors[(int)ImGuiCol.TitleBg] = Black.ARGBSetAlpha(0.9f);
        colors[(int)ImGuiCol.TitleBgActive] = Dark0;
        colors[(int)ImGuiCol.TitleBgCollapsed] = Dark0.ARGBSetAlpha(0.5f);
        ...
        colors[(int)ImGuiCol.Button] = Medium1.ARGBSetAlpha(0.8f);
        colors[(int)ImGuiCol.ButtonHovered] = Medium2.ARGBSetAlpha(0.8f);
        colors[(int)ImGuiCol.ButtonActive] = Light1.ARGBSetAlpha(0.8f);
        colors[(int)ImGuiCol.Header] = Medium1.ARGBSetAlpha(0.7f);
        colors[(int)ImGuiCol.HeaderHovered] = Medium2.ARGBSetAlpha(0.7f);
        colors[(int)ImGuiCol.HeaderActive] = Light0.ARGBSetAlpha(0.7f);
