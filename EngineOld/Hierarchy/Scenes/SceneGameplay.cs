...
public class SceneGameplay : Scene
{
    ...
    public override void Update()
    {
        ...
        {
            _windowScareCooldown -= GameTime.DeltaTime;
        }
        ...
        {
            _kitchenCooldown -= GameTime.DeltaTime;
        }
        else
        {
            if (_kitchenSoundChance < 1f)
            {
                _kitchenSoundChance += KITCHEN_CHANCE_INC_PERSEC * GameTime.DeltaSecondsF;
            }
        ...
        Camera.Transform.PositionX = Lerp.TowardsSmooth(Camera.Transform.PositionX, cameraX, 5f, GameTime.DeltaSecondsF);
